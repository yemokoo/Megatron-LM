...
RAW_DIR="${RAW_DIR:-/workspace/FLAME-MoE/.local/dataset/wikipedia-full/raw}"
TOK_DIR="${TOK_DIR:-/workspace/FLAME-MoE/.local/dataset/wikipedia-full/tokenized/EleutherAI/pythia-12b}"
LOG_PATH="${LOG_PATH:-/workspace/FLAME-MoE/.logs/wiki_full_tokenize.log}"
