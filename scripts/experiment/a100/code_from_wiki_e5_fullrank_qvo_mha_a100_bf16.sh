...
export RUN_ID="${RUN_ID:-e5-wiki-to-code-ffn-attn-lora-qvo-r${ATTN_LORA_RANK}-single-router-moe-mha-a100-bf16-$(date -u +%Y%m%d-%H%M%S)}"
...
export WANDB_EXP_NAME="${WANDB_EXP_NAME:-E5 - FullRank QVO LoRA Expert - wiki to code}"
