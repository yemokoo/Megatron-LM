...
export STAGE_DIR_NAME="${STAGE_DIR_NAME:-a100/mha/f-attn-full-rank-lora-bf16-freeze}"
export RUN_ID="${RUN_ID:-f2-wiki-to-code-ffn-moe-freeze-attn-full-rank-lora-mha-a100-bf16-$(date -u +%Y%m%d-%H%M%S)}"
export WANDB_PROJECT="${WANDB_PROJECT:-flame-continual-top2-qv-lora}"
export WANDB_EXP_NAME="${WANDB_EXP_NAME:-F2 - Wiki to Code FFN MoE Freeze + Attn Full-Rank LoRA MHA}"
