...
export E5_WIKI_RUN_ID="${E5_WIKI_RUN_ID:-e5-wiki-ffn-attn-lora-qvo-r${E5_ATTN_LORA_RANK}-single-router-moe-mha-a100-bf16-mb${E5_WIKI_MICRO_BATCH_SIZE}-1800}"
export E5_CODE_RUN_ID="${E5_CODE_RUN_ID:-e5-wiki-to-code-ffn-attn-lora-qvo-r${E5_ATTN_LORA_RANK}-single-router-moe-mha-a100-bf16-mb${E5_CODE_MICRO_BATCH_SIZE}-1800}"
...
run_and_pause "1_E5_wiki" env \
    ...
    WANDB_EXP_NAME="E5 - fullrank qvo - wiki" \
    ...
    bash "$SCRIPT_DIR/wiki_e5_fullrank_qvo_mha_a100_bf16.sh"
...
run_and_pause "2_E5_code" env \
    ...
    WANDB_PROJECT=flame-continual-top2-qv-lora \
    WANDB_EXP_NAME="E5 - fullrank qvo - wiki to code" \
    ...
    MASTER_PORT=29662 \
    "$SCRIPT_DIR/run_guarded_training.sh" \
    bash "$SCRIPT_DIR/code_from_wiki_e5_fullrank_qvo_mha_a100_bf16.sh"
