...
export RUN_ID="${RUN_ID:-g2-shared-router-conv-wikicode-joint-lm-allrouter-112-${SAFE_MODE}-init-mb${MICRO_BATCH_SIZE}-${TRAIN_ITERS}}"
export TRAIN_WEIGHTS="${TRAIN_WEIGHTS:-$G2_ROOT/conversation/shared_router_joint_lm_replay/$RUN_ID}"
...
exec bash "$PROJECT_ROOT/scripts/experiment/continual_shared_router_hybrid_evalonly_local_bf16.sh"
