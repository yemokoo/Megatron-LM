...
export RUN_ID="${RUN_ID:-g2-top4-e8to16-ffn352-r256-wiki-to-code-shared-router-qkvo-mha-a100-bf16-mb72-teacher-student-router-kd-fullwiki-kl0p1-1800}"
...
env \
    ...
    WANDB_EXP_NAME="G2 - teacher-student router KD fullwiki kl0p1 - wiki to code" \
