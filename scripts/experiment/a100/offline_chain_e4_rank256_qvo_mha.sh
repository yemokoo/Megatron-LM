...
export E4_WIKI_RUN_ID="${E4_WIKI_RUN_ID:-e4-wiki-ffn-attn-lora-qvo-r256-single-router-moe-mha-a100-bf16-mb64-1800}"
export E4_CODE_RUN_ID="${E4_CODE_RUN_ID:-e4-wiki-to-code-ffn-attn-lora-qvo-r256-single-router-moe-mha-a100-bf16-mb32-1800}"
...
run_and_pause "1_E4_wiki" env \
    ...
    WANDB_EXP_NAME="E4 - rank256 qvo - wiki" \
    MICRO_BATCH_SIZE=64 \
...
run_and_pause "2_E4_code" env \
    ...
    WANDB_PROJECT=flame-continual-top2-qv-lora \
    WANDB_EXP_NAME="E4 - rank256 qvo - wiki to code" \
    MICRO_BATCH_SIZE=32 \
    GLOBAL_BATCH_SIZE=2304 \
    TRAIN_ITERS=1800 \
