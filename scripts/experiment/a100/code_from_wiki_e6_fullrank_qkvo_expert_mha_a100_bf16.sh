...
export RUN_ID="${RUN_ID:-e6-wiki-to-code-ffn-attn-fullrank-qkvo-expert-single-router-moe-mha-a100-bf16-$(date -u +%Y%m%d-%H%M%S)}"
...
export WANDB_EXP_NAME="${WANDB_EXP_NAME:-E6 - Wiki to Code FFN+Attn Full-Rank QKVO Expert Single Router MoE MHA}"
