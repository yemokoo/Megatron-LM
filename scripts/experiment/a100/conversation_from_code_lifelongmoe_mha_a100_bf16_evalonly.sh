...
export RUN_ID="${RUN_ID:-lifelongmoe-e16to24-conv-kl${OLD_MODEL_KL_COEFF}-mb${MICRO_BATCH_SIZE}-${TRAIN_ITERS}}"
...
exec bash "$SCRIPT_DIR/run_continual_moe_a100_bf16_lprjoint_evalonly.sh"
