...
export TRAIN_ATTENTION_WITH_NEW_EXPERTS=1
...
export RUN_ID="${RUN_ID:-a2-wiki-to-conversation-ffn-moe-attn-unfreeze-mha-a100-bf16-$(date -u +%Y%m%d-%H%M%S)}"
export WANDB_PROJECT="${WANDB_PROJECT:-flame-continual-top2-qv-lora}"
export WANDB_EXP_NAME="${WANDB_EXP_NAME:-A2 - Wiki to Conversation FFN MoE Attention Unfreeze MHA}"
