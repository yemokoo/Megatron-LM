...
class LoraModel(torch.nn.Module):
    ...
    Example:
        ...
        >>> from utils.my_peft import LoraModel, LoraConfig
        ...
        ```py
        >>> import transformers
        >>> from utils.my_peft import LoraConfig, PeftModel, get_peft_model, prepare_model_for_int8_training
    ...
    **Attributes**:
    ...
    def _find_and_replace(self, adapter_name):
        ...
        # Count depth for LoRA layers
        depth_count = 0
        max_depth = getattr(lora_config, "depth", -1)
        
        for key in key_list:
            # Check if we've reached the maximum depth
            if max_depth > 0 and depth_count >= max_depth:
                break
            ...
            if target_module_found:
                ...
                if isinstance(target, LoraLayer):
                    ...
                    # Increment depth counter after successfully adding a LoRA layer
                    depth_count += 1
