...
class PeftModelForSequenceClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from utils.my_peft import PeftModelForSequenceClassification, get_peft_config
...
class PeftModelForCausalLM(PeftModel):
    ...
    Example:
        ...
        >>> from utils.my_peft import PeftModelForCausalLM, get_peft_config
...
class PeftModelForSeq2SeqLM(PeftModel):
    ...
    Example:
        ...
        >>> from utils.my_peft import PeftModelForSeq2SeqLM, get_peft_config
...
class PeftModelForTokenClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        ```py
        >>> from transformers import AutoModelForSequenceClassification
        >>> from utils.my_peft import PeftModelForTokenClassification, get_peft_config
