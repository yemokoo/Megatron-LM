...
gpt_shared_router_attention_only_local_spec = ModuleSpec(
    module=SharedRouterAttentionOnlyTransformerLayer,
    submodules=SharedRouterHybridLayerSubmodules(
        input_layernorm=LNImpl,
        self_attention=ModuleSpec(
            module=SharedRouterQVLoraSelfAttention,
...
gpt_two_router_hybrid_local_spec = ModuleSpec(
    module=TwoRouterHybridTransformerLayer,
    submodules=SharedRouterHybridLayerSubmodules(
        input_layernorm=LNImpl,
        self_attention=ModuleSpec(
            module=SharedRouterQVLoraSelfAttention,
